				...
				for (int z = 0; z < chunkSize; z++) {
					...
					for (int side = 0; side < 6; side++) {
						...
						for (int i = 0; i < 4; i++) {
							...
							//int3 vertWorldPos = vertLocalPos + blockPos + worldPos;

							//Ambient occlusion actually has a bias since quads are triangles, and will work differently
							//at different diagonals for every plane. This MAY BE WORTH FIXING!!!!!!!!!!!!
							...
							//check #1 last since its the corner block, which has the weakest shadow
							...
							//debug, print out binary data of any vertices of block 0, 0, 0
